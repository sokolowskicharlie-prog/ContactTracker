                    ...
                    >
                      ...
                      {(contact.average_mt_enquiry !== null && contact.average_mt_enquiry !== undefined ||
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {contact.average_mt_enquiry !== null && contact.average_mt_enquiry !== undefined && (
                            <div className="flex items-center gap-1.5 text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded border border-blue-200 whitespace-nowrap">
                              <Package className="w-3 h-3" />
                              <span className="font-medium">{contact.average_mt_enquiry} MT</span>
                            </div>
                          )}
                          {contact.average_margin !== null && contact.average_margin !== undefined && (
                            <div className="flex items-center gap-1.5 text-xs bg-green-50 text-green-700 px-2 py-1 rounded border border-green-200 whitespace-nowrap">
                              <DollarSign className="w-3 h-3" />
                              <span className="font-medium">{contact.average_margin}%</span>
                            </div>
                          )}
                          {contact.number_of_deals !== null && contact.number_of_deals !== undefined && (
                            <div className="flex items-center gap-1.5 text-xs bg-purple-50 text-purple-700 px-2 py-1 rounded border border-purple-200 whitespace-nowrap">
                              <Briefcase className="w-3 h-3" />
                              <span className="font-medium">{contact.number_of_deals} {contact.number_of_deals === 1 ? 'deal' : 'deals'}</span>
                            </div>
                          )}
                          {contact.average_days_credit_required !== null && contact.average_days_credit_required !== undefined && (
                            <div className="flex items-center gap-1.5 text-xs bg-amber-50 text-amber-700 px-2 py-1 rounded border border-amber-200 whitespace-nowrap">
